...
export const DialogSizesTSXCode = (
  <pre className='language-jsx'>
    <code className='language-jsx'>{`// ** React Imports
import { Fragment, useState, React.ChangeEvent } from 'react'
...
import FormControlLabel from '@mui/material/FormControlLabel'
import DialogContentText from '@mui/material/DialogContentText'
import Select, { SelectReact.ChangeEvent } from '@mui/material/Select'
...
const DialogSizes = () => {
  ...
  const handleMaxWidthChange = (event: SelectReact.ChangeEvent) => {
