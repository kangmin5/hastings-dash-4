...
// ** Type Imports
import { CustomRadioBasicData, CustomRadioIconsData, CustomRadioIconsProps } from '@core/components/custom-radio/types'
...
const StepAddress = ({ handleNext }: { handleNext: () => void }) => {
  ...
  // ** States
  const [selectedIconRadio, setSelectedIconRadio] = React.useState<string>(initialIconSelected)
  const [selectedBasicRadio, setSelectedBasicRadio] = React.useState<string>(initialBasicSelected)
  ...
  const handleBasicRadioChange = (prop: string | React.ChangeEvent<HTMLInputElement>) => {
  ...
  const handleIconRadioChange = (prop: string | React.ChangeEvent<HTMLInputElement>) => {
    if (typeof prop === 'string') {
