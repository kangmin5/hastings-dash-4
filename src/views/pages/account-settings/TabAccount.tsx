...
const TabAccount = () => {
  ...
  const [userInput, setUserInput] = React.useState<string>('yes')
  const [formData, setFormData] = React.useState<Data>(initialData)
  const [imgSrc, setImgSrc] = React.useState<string>('/images/avatars/1.png')
  const [secondDialogOpen, setSecondDialogOpen] = React.useState<boolean>(false)
  ...
  const handleInputImageChange = (file: React.ChangeEvent) => {
