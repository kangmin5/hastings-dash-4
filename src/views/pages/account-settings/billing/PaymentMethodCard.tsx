...
const PaymentMethodCard = () => {
  ...
  const [cvc, setCvc] = React.useState<string | number>('')
  const [cardNumber, setCardNumber] = React.useState<string>('')
  const [focus, setFocus] = React.useState<Focused | undefined>()
  const [expiry, setExpiry] = React.useState<string | number>('')
  ...
  const [selectedCard, setSelectedCard] = React.useState<SelectedCardType | null>(null)
  ...
  const handleInputChangeDialog = ({ target }: React.ChangeEvent<HTMLInputElement>) => {
