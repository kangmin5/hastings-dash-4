...
const UserViewBilling = () => {
  ...
  const [dialogTitle, setDialogTitle] = React.useState<string>('Add')
  const [openEditCard, setOpenEditCard] = React.useState<boolean>(false)
  const [openAddressCard, setOpenAddressCard] = React.useState<boolean>(false)
  const [openUpgradePlans, setOpenUpgradePlans] = React.useState<boolean>(false)
  const [subscriptionDialogOpen, setSubscriptionDialogOpen] = React.useState<boolean>(false)
