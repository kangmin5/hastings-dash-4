...
import { DataGrid, GridColumns, GridRenderCellParams, GridSortModel, GridColDef } from '@mui/x-data-grid'
...
const TableServerSide = () => {
  ...
  const [rows, setRows] = React.useState<DataGridRowType[]>([])
  const [searchValue, setSearchValue] = React.useState<string>('')
  const [sortColumn, setSortColumn] = React.useState<string>('full_name')
