...
const FormLayoutsBasic = () => {
  ...
  const [confirmPassValues, setConfirmPassValues] = React.useState<State>({
    password: '',
    showPassword: false
  })
  ...
  const handleConfirmPassChange = (prop: keyof State) => (event: React.ChangeEvent<HTMLInputElement>) => {
