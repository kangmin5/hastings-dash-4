...
export class DormantTo {
  ...
  setDoze(doze: DozeAtom): void {
    this.doze = new DozeBuilder().transform()
  }
...
export class DormantBo {
  private readonly instance: DormantVo
  ...
  car(car: CarAtom): DormantBo {
    this.instance.car = car
    return this
  }
  person(person: PersonAtom): DormantBo {
    this.instance.person = person
    return this
  }

  time(time: TimeAtom): DormantBo {
    this.instance.time = time
    return this
  }
  calc(calc: CalcAtom): DormantBo {
    this.instance.calc = calc
    return this
  }
  user(user: UserAtom): DormantBo {
    this.instance.user = user
    return this
  }
  consult(consult: ConsultAtom): DormantBo {
    this.instance.consult = consult
    return this
  }

  funnel(funnel: FunnelAtom): DormantBo {
    this.instance.funnel = funnel
    return this
  }

  rowCount(rowCount: RowCountAtom): DormantBo {
    this.instance.rowCount = rowCount
    return this
  }

  today(today: TodayAtom): DormantBo {
    this.instance.today = today
    return this
  }
  total(total: TotalAtom): DormantBo {
    this.instance.total = total
    return this
  }
  adobe(adobe: AdobeAtom): DormantBo {
    this.instance.adobe = adobe
    return this
  }
  work(work: WorkAtom): DormantBo {
    this.instance.work = work
    return this
  }
  mobile(mobile: MobileAtom): DormantBo {
    this.instance.mobile = mobile
    return this
  }
  bank(bank: BankAtom): DormantBo {
    this.instance.bank = bank
    return this
  }
  wallet(wallet: WalletAtom): DormantBo {
    this.instance.wallet = wallet
    return this
  }
  reserve(reserve: ReserveAtom): DormantBo {
    this.instance.reserve = reserve
    return this
  }
  memo(memo: MemoAtom): DormantBo {
    this.instance.memo = memo
    return this
  }
  inquiryKind(inquiryKind: []): DormantBo {
    this.instance.inquiryKind = inquiryKind
    return this
  }
  ordersNotEnd(ordersNotEnd: []): DormantBo {
