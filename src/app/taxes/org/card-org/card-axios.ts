...
import { CardUrl as url } from './card-union'
...
export interface CardType extends CrudAxios<CardVo> {}
export class CardAxios implements CardType {
  private static instance: CardAxios
  ...
  public static then(): CardAxios {
    if (!CardAxios.instance) {
      CardAxios.instance = new CardAxios()
    }

    return CardAxios.instance
  }

  addOne(parameter: CardVo): Promise<AxiosResponse<any>> {
  ...
  getAll(parameter: CardVo): Promise<AxiosResponse<any>> {
    const { method, url, headers, data }: AjaxVo = this.router.http({
      url: getAll,
      method: get,
      data: null
  ...
  getBy(parameter: CardVo): Promise<AxiosResponse<any>> {
    const { method, url, headers, data }: AjaxVo = this.router.http({
      url: getBy,
      method: post,
      data: parameter
  ...
  getById(parameter: CardVo): Promise<AxiosResponse<any>> {
    const { method, url, headers, data }: AjaxVo = this.router.http({
      url: getById,
      method: get,
      data: parameter
  ...
  alterById(parameter: CardVo): Promise<AxiosResponse<any>> {
    const { method, url, headers, data }: AjaxVo = this.router.http({
      url: alterById,
      method: put,
      data: parameter
  ...
  delById(parameter: CardVo): Promise<AxiosResponse<any>> {
    const { method, url, headers, data }: AjaxVo = this.router.http({
      url: delById,
      method: del,
      data: parameter
