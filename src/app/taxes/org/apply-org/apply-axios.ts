...
import { ApplyUrl as url } from './apply-union'
...
export interface ApplyType extends CrudAxios<ApplyVo> {}
export class ApplyAxios implements ApplyType {
  private static instance: ApplyAxios
  ...
  public static then(): ApplyAxios {
    if (!ApplyAxios.instance) {
      ApplyAxios.instance = new ApplyAxios()
    }

    return ApplyAxios.instance
  }

  addOne(parameter: ApplyVo): Promise<AxiosResponse<any>> {
  ...
  getAll(parameter: ApplyVo): Promise<AxiosResponse<any>> {
    const { method, url, headers, data }: AjaxVo = this.router.http({
      url: getAll,
      method: get,
      data: null
  ...
  getBy(parameter: ApplyVo): Promise<AxiosResponse<any>> {
    const { method, url, headers, data }: AjaxVo = this.router.http({
      url: getBy,
      method: post,
      data: parameter
  ...
  getById(parameter: ApplyVo): Promise<AxiosResponse<any>> {
    const { method, url, headers, data }: AjaxVo = this.router.http({
      url: getById,
      method: get,
      data: parameter
  ...
  alterById(parameter: ApplyVo): Promise<AxiosResponse<any>> {
    const { method, url, headers, data }: AjaxVo = this.router.http({
      url: alterById,
      method: put,
      data: parameter
  ...
  delById(parameter: ApplyVo): Promise<AxiosResponse<any>> {
    const { method, url, headers, data }: AjaxVo = this.router.http({
      url: delById,
      method: del,
      data: parameter
