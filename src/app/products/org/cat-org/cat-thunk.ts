...
export const getAllCats = createAsyncThunk(action.getAll, (parameter?: CatVo) => axios.then().getAll(parameter))
export const getCatsBy = createAsyncThunk(action.getBy, (parameter: CatVo) => axios.then().getBy(parameter))
