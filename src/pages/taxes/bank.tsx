...
// ** Icon Imports
const MyIcon = ({ icon, ...rest }: IconProps) => {
...
// ** Custom Components
import CustomChip from './bank/chip'
import UserSubscriptionDialog from './bank/UserSubscriptionDialog'

// ** Util Import
import { formatCVC, formatExpirationDate, formatCreditCardNumber } from './bank/format'

// ** Types
import type {CustomChipProps as ThemeColor}  from './bank/types'

// ** Styled Component Imports
import CardWrapper from './bank/react-credit-cards'
          ...
          <CardHeader
            ...
            action={
              <Button variant='contained' onClick={handleAddCardClickOpen} sx={{ '& svg': { mr: 1 } }}>
                <MyIcon icon='mdi:plus' fontSize='1.125rem' />
                Add Card
              </Button>
            }
          />
