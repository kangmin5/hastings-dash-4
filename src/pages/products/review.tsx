...
import { selectReviewsByUser, selectItemCount } from 'app/products/org/review-org/review-selector'
import { useSelector } from 'react-redux'
import {  getReviewsByUser } from 'app/products/org/review-org/review-thunk'
import {
  Box,
  Button,
  Card,
...
const ReviewPage: NextPage = ({post}: Parameters) => {
  ...
  const ReviewsByUser = useSelector(selectReviewsByUser)
  ...
  React.useEffect(() => {
    ...
    dispatch(getReviewsByUser(undefined))
  }, [dispatch, router.query])

  interface CellType {
    row: ReviewVo
  }
  const ReviewColumn = (): GridColDef[] => {
    return [
      {
        flex: 0.1,
        minWidth: 120,
