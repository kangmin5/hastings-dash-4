...
import { selectItemCount, selectAllProducts } from 'app/products/org/product-org/product-selector'
...
const MainProductPage: NextPage = ({ post }: Parameters) => {
  ...
  const ProductColumn = (): GridColDef[] => {
    return [
      ...
      },
      {
        ...
        headerName: '가격',
        renderCell({ row }: CellType) {
          return <Typography variant='body2'>{row.price.unitPrice}</Typography>
        }
      },
      {
        flex: 0.08,
      ...
      <Card>
        ...
        <div className='dataGrid-wrap'>
          ...
          <div className='data-function'>
            <span className='total'>총 10 개</span>
