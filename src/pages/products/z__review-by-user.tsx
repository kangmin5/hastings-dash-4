...
// const ReviewByUserPage: NextPage = ({post}: Parameters) => {
//   const dispatch = useAppDispatch()
//   const c = useSelector(selectCustomerById)

//   React.useEffect(() => {
//     console.log('회원-상품리뷰 이펙트 : ', JSON.stringify(c))
//     dispatch(getReviewsByUser(c))
//   }, [c, dispatch])
...
//         rows={tuples}
//         getRowId={row => row.id}
//         columns={ProductReviewGridColumns()}
//         checkboxSelection
...
//   )
// }
// export default ReviewByUserPage;
