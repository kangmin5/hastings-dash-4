...
export default function AddressPage() {
  ...
  const [tuples, setTuples] = React.useState<AddrVo[]>([])
  function handleRadioChange(event: React.ChangeEvent<HTMLInputElement>) {
    // DeliveryAddresses.new().type().all().then(function (res: any) {
  ...
  return (
    <>
      ...
      <DataGrid
        ...
        rows={tuples}
        getRowId={row => row.id}
        columns={DeliveryAddressGridColumns()}
        checkboxSelection
