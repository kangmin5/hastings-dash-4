...
import { getAllQuickEntries } from 'app/quotes/org/quick-entry-org/quick-entry-thunk'
...
const QuickItemPage: NextPage = ({post}: Parameters) => {
  ...
  const [tuples, setTuples] = React.useState<QuickEntryVo[]>([])
  ...
  React.useEffect(() => {
    ...
    dispatch(getAllQuickEntries(undefined))
  }, [dispatch])

  const QuickItemColumn = (): GridColDef[] => [
  ]
