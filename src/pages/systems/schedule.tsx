...
import { CalendarColors, CalendarFiltersType } from 'app/systems/mo/schedule-mo/schedule-vo'
...
} from 'app/systems/org/schedule-org/schedule-slice'
import {
  addEvent,
  fetchEvents,
  deleteEvent,
...
} from 'app/systems/org/schedule-org/schedule-thunk'
...
const AppCalendar = () => {
  ...
  const store = useSelector((state: RootState) => state.schedules)
